  ...
  return(
    <main className="max-w-screen-2xl mx-auto">
      <section className="flex flex-row md:flex-row justify-center gap_12 md:gap-48 mt-20 md:mt-40 mx-6 md:mx-12">
        ...
        <h3 className="font-light text-xl md:text-2xl mb-2 sm:mx-6 md:mx-32 overflow-hidden whitespace-nowrap border-r-2 border-black animate-typewriter">Hello I&apos;m</h3>
        ...
        <div>
        <Image src="/pfp.jpg" alt="Logo" width={200} height={200} priority className="rounded-full scale-100 hover:scale-110 shadow-lg shadow-black  md:w-96 md:h-96"/>
        </div>
      </section>
